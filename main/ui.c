...
//    ui_Screen1 = lv_obj_create(NULL);
    ...
    lv_obj_set_width(ui_TextArea1, 110);
    lv_obj_set_height(ui_TextArea1, 38);
    lv_obj_set_x(ui_TextArea1, -97);
    lv_obj_set_y(ui_TextArea1, 50);
    lv_obj_set_align(ui_TextArea1, LV_ALIGN_CENTER);
    lv_textarea_set_text(ui_TextArea1, "0");
    lv_obj_set_style_text_color(ui_TextArea1, lv_color_hex(0x0000FF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_TextArea2, 97);
    lv_obj_set_y(ui_TextArea2, 50);
    lv_obj_set_align(ui_TextArea2, LV_ALIGN_CENTER);
    lv_textarea_set_text(ui_TextArea2, "0");
    lv_obj_set_style_text_color(ui_TextArea2, lv_color_hex(0x0000FF), LV_PART_MAIN | LV_STATE_DEFAULT);
